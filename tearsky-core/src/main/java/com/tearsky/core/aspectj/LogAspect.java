package com.tearsky.core.aspectj;
...
import com.tearsky.common.enums.BusinessStatus;
import com.tearsky.common.json.JSON;
...
public class LogAspect {
	...
	// 配置织入点
	@Pointcut("@annotation(com.tearsky.common.annotation.Log)")
